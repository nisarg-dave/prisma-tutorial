...
CREATE TABLE "Post" (
    ...
    "favouritedById" INTEGER NOT NULL,
...
-- AddForeignKey
ALTER TABLE "Post" ADD CONSTRAINT "Post_favouritedById_fkey" FOREIGN KEY ("favouritedById") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
